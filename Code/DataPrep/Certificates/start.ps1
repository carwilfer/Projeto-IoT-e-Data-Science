...
python aws-iot-device-sdk-python\samples\basicPubSub\basicPubSub.py -e auwr8r23bm2np-ats.iot.us-east-1.amazonaws.com -r root-CA.crt -c computerAcidentes.cert.pem -k computerAcidentes.private.key
